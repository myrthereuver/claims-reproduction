# coding=utf-8
# This code trains a classifier that classifies a topic+sentence
# into the categories: NoArgument, Argument_for, Argument_against
# The code is based on HuggingFace classification example:
# https://github.com/huggingface/pytorch-pretrained-BERT/blob/v0.6.2/examples/run_classifier.py
...
# tracker = ImpactTracker('bert_output/18May/Seed1/impact/')
